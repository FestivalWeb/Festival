          ...
          <div className="content-bottom footer-contact">
             <div className="cb-left">
              <div className="icon-list">
                  {/* ▼▼▼ 수정된 부분: 링크 적용 ▼▼▼ */}
                  <a href="https://instagram.com/nonsan.korea" target="_blank" rel="noopener noreferrer" className="icon-row" style={{textDecoration: 'none', color: 'inherit'}}>
                      <img src={instaIcon} alt="instagram" className="footer-icon"/> <span>인스타그램</span>
                  </a>
                  <a href="https://www.youtube.com/@Nonsan" target="_blank" rel="noopener noreferrer" className="icon-row" style={{textDecoration: 'none', color: 'inherit'}}>
                      <img src={ytIcon} alt="youtube" className="footer-icon"/> <span>유튜브</span>
                  </a>
                  {/* 이메일은 링크 아님 */}
                  <div className="icon-row">
                      <img src={mailIcon} alt="email" className="footer-icon"/> <span>이메일</span>
                  </div>
              </div>
            </div>
